# side-quests.md — Exploration Technique & Leviers Long Terme

## Objectif du document

Ce document regroupe des axes d’exploration **non critiques à court terme**,
mais stratégiques à moyen / long terme pour :

- augmenter mon effet de levier technique,
- élargir mes capacités produit,
- nourrir une vision long terme (entreprise, produits propres).
...
- Consommer un modèle existant avant d’en entraîner un
- Comprendre :
  - coûts
  - latence
  - limites
...
- Orchestration (concepts avant outils)
...
- Une side quest doit avoir :
  - une motivation claire
  - une borne temporelle
- Pas d’exploration sans hypothèse
- Pas de deep dive tant que le produit n’est pas livré
...
Les side quests existent pour :

- augmenter ta surface de jeu,
- affiner ton jugement,
- préparer l’avenir.

Elles ne sont **jamais** une excuse pour ne pas livrer.
